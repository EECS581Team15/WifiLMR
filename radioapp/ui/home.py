...
class UIHome:
    ...
    def add_buttons(self, master):
        ...
        self.button_1 = tk.Button(self.bottom_frame, text="1", bg="#3399ff", fg="white", height=1, width=6, 
                                  command=lambda: master.switch_screen(master.display_ui_back_light))
        self.button_1.grid(row=7, column=0, sticky="nsew")

        self.button_2 = tk.Button(self.bottom_frame, text="2", height=1, width=6, fg="white", bg="#3399ff")
        self.button_2.grid(row=7, column=1, sticky="nsew")

        self.button_3 = tk.Button(self.bottom_frame, text="3", height=1, width=7, fg="white", bg="#3399ff")
