...
RADIOAPP_PRE_EXTRACT_HOOKS += RADIOAPP_BUILD_SRC RADIOAPP_MAKE_DL_DIR
RADIOAPP_PRE_BUILD_HOOKS += RADIOAPP_REMOVE_EXTRACT_STAMP
RADIOAPP_SOURCE = ../../../../radioapp/dist/radioapp-$(RADIOAPP_VERSION).tar.gz
